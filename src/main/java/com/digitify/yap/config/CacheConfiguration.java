package com.digitify.yap.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MicroserviceA");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MicroserviceA");
        ...
        config.getMapConfigs().put("com.digitify.yap.domain.*", initializeDomainMapConfig(jHipsterProperties));
